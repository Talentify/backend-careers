                            ...
                            <form class="form-horizontal" action="{{ route($details['route'].'.update', $data['id']) }}" method="post">
                                ...
                                <div class="card-body pt-2 pb-0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" name="description" rows="3">{{ isset($data['description']) ? $data['description'] : old('description')}}</textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" id="address" name="address" value="{{ isset($data['address']) ? $data['address'] : old('address')}}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="salary">Salário</label>
                                        <input type="number" class="form-control form-control-sm" id="salary" name="salary" value="{{ isset($data['salary']) ? $data['salary'] : old('salary')}}" required>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label" for="company">Empresa</label>
                                        <input type="text" class="form-control form-control-sm" id="company" name="company" value="{{ isset($data['company']) ? $data['company'] : old('company')}}" required>
                                    </div>
                                    <div class="form-group">
